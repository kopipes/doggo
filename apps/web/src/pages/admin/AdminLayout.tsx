...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen flex t-bg-base t-text-primary">
      {/* Sidebar */}
      <aside className="w-56 shrink-0 flex flex-col border-r t-sidebar-bg t-border">
        {/* Logo */}
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
          {navItems.filter(i => !i.adminOnly || isAdmin).map(item => (
            <NavLink
              ...
              to={item.to}
              className={({ isActive }) =>
                `flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-colors border ${
      ...
      {/* Main content */}
      <main className="flex-1 p-6 overflow-auto t-bg-base">
        <Outlet />
      </main>
    </div>
  )
